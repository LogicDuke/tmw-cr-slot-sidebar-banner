...
class TMW_CR_Slot_Admin_Page {
    ...
    /**
     * Import allowed-country and final-url overrides from a single combined submit.
     *
     * @return void
     */
    ...
    /**
     * Import final URL override rows from CSV text.
     *
     * @param string $raw_csv Raw CSV text.
     *
     * @return array<string,int> Imported, rejected, and total saved counts.
     */
    ...
    /**
     * Import allowed-country override rows from CSV text.
     *
     * @param string $raw_csv Raw CSV text.
     *
     * @return array<string,int> Imported, rejected, and total saved counts.
    ...
    /**
     * Redirect to the plugin settings page with notice and explicit tab context.
     *
     * @param string $notice_type Notice type.
     * @param string $message     Notice message.
     * @param string $tab_slug    Tab slug to return to.
     *
     * @return void
     */
