...
= 1.9.4 =
* Restored compact desktop/main banner card sizing after the v1.9.2 mobile layout change.
* Kept mobile 3-card final row behavior.
* Kept SPIN NOW, clean public offer names, and CTA new-tab behavior.
