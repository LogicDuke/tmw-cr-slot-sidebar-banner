...
= 1.10.0 =
* [TMW-FEAT] Added a filterable, runtime-only CR recommended offer priority layer for frontend smart-fill ordering.
* Explicit manual selections and stored manual priority remain strongest. Recommendations never override eligibility, country targeting, disabled status, allowed offer types, or other frontend exclusions.
* Preserved all frontend pool modes and smart-fill of eligible non-recommended synced offers. No credentials, destination URLs, or tracking URLs were added.
